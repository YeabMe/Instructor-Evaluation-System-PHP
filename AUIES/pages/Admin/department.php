...
?>
    ...
    <head>
        ...
        <title>AUIES Department-list</title>
        <!-- base:css -->
                    ...
                    <div class="modal fade" id="studentadd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="../../db_php/department_crud.php" method="POST">
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label>Department Name</label>
                                            <input type="text" name="dep" class="form-control" placeholder="Enter Department name" required>
                                        </div>
                            ...
                            <div class="modal-content">
                                ...
                                <form action="../../db_php/department_crud.php" method="POST">
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label>Department Name</label>
                                            <input type="text" name="dep" id="dep" class="form-control" placeholder="Enter department name" required>
                                        </div>
