                    ...
                    <div class="modal fade" id="studentadd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="../../db_php/instructor_crud.php" method="POST">
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label>Instructor Id</label>
                                            <input type="text" name="sid" class="form-control" placeholder="Enter Instructor Id" required>
                                        </div>
                                        <div class="mb-3">
                            ...
                            <div class="modal-content">
                                ...
                                <form action="../../db_php/instructor_crud.php" method="POST">
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label>Instructor id</label>
                                            <input type="text" name="iid" id="iid" class="form-control" placeholder="Enter id" required>
                                        </div>
                                        <div class="mb-3">
                                            <label>First Name</label>
