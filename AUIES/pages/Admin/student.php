                    ...
                    <div class="modal fade" id="studentadd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="../../db_php/student_crud.php" method="POST">
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label>School Id</label>
                                            <input type="text" name="sid" class="form-control" placeholder="Enter School Id" required>
                                        </div>
                                        <div class="mb-3">
