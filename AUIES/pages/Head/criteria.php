...
?>
    ...
    <head>
        ...
        <title>AUIES Students-list</title>
        <!-- base:css -->
                ...
                <div class="main-panel" style="overflow:scroll !important;">
                    ...
                    <div class="modal fade" id="studentadd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="../../db_php/criteria_crud.php" method="POST">
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label>Criteria</label>
                                            <input type="text" name="cri" class="form-control" placeholder="Enter Criteria name" required>
                                        </div>
                    ...
                    <div class="modal fade" id="edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Edit Criteria Data</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                ...
                                <form action="../../db_php/criteria_crud.php" method="POST">
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label>Criteria</label>
                                            <input type="text" name="cri" id="cri" class="form-control" placeholder="Enter Criteria name" required>
                                        </div>
                    ...
                    <div class="modal fade" id="delete" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Delete Criteria Data</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
