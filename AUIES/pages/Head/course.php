                    ...
                    <div class="modal fade" id="studentadd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="../../db_php/course_crud.php" method="POST">
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label>Course</label>
                                            <input type="text" name="cor" class="form-control" placeholder="Enter Course" required>
                                        </div>
                                        <div class="mb-3">
                                            <label>Discription</label>
                                            <input type="text" name="dis" class="form-control" placeholder="Enter Discription" required>
                                        </div>
                                        <div class="mb-3">
                            ...
                            <div class="modal-content">
                                ...
                                <form action="../../db_php/course_crud.php" method="POST">
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label>Course Code</label>
                                            <input type="text" name="code" id="code" class="form-control" placeholder="Enter Course code" required>
                                        </div>
                                        <div class="mb-3">
                                            <label>Course</label>
                                            <input type="text" name="cor" id="cor" class="form-control" placeholder="Enter Course" required>
                                        </div>
                                        <div class="mb-3">
                                            <label>Discription</label>
                                            <input type="text" name="dis" id="dis" class="form-control" placeholder="Enter Discription" required>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
