                ...
                <form action="../../db_php/question_crud.php" method="POST">
                  <div class="modal-body">
                    <div class="mb-3">
                      ...
                      <input type="text" name="q" class="form-control" placeholder="Enter Question" required>
                    </div>
                    <div class="mb-3">
                      <label>Criteria</label>
                      <select name="cri" id="cri">
                        <?php
                        $value = "select * from criteria";
              ...
              <div class="modal-content">
                ...
                <form action="../../db_php/question_crud.php" method="POST">
                  <div class="modal-body">
                    ...
                    <div class="mb-3">
                      <label>Question</label>
                      <input type="text" name="q" id="q" class="form-control" placeholder="Enter Question" required>
                    </div>
                    <div class="mb-3">
                      <label>Criteria</label>
                      <select name="cri" id="cri">
            ...
            <div class="jumbotron">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <button type="button" class="btn btn-primary" onclick="window.location.href='restriction.php'">
                    Restriction
                  </button>
                  <?php
                ...
                <div class="card-body">
                  ...
                  <table id="datatable" class="table table-sm">
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT * FROM question where department='$d' and evaluation_id='$e'";
                      $res = $con->query($sql);
