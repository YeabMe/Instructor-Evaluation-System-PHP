            ...
            <div class="jumbotron">
              ...
              <div>
                ...
                <div>
                  ...
                  <?php
                  $d = $_SESSION['Sname'];
                  $value = "select * from student where username='" . $d . "'";
                    ...
                    <form action="../../db_php/manage.php" method="POST">
                      <div class="modal-body">
                        ...
                        <?php
                         ...
                         <div class="mb-3">
                          <label>Section</label>
                          <input type="text" name="sec" id="sec" class="form-control" placeholder="Enter Section" required value="<?php echo $row['section']; ?>">
                        </div>
                        <?php } ?>
                        <div class="mb-3">
                      ...
                      <div>
                        ...
                        <button type="Submit" name="managestudent" class="btn btn-primary">Update data</button>
                      </div>
                    </form>
